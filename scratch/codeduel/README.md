...
- Demo accounts:
  - `anshu` / `password123` (Rating: 1542, Rank: #248)
...
CodeDuel implements normalized scoring so that writing an optimal algorithm ($O(n)$ vs $O(n^2)$) yields victory:
