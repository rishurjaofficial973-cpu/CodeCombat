...
public class MatchmakingService {
    ...
    @Value("${codeduel.matchmaking.rating-window-initial:50}")
    private int initialWindow;

    @Value("${codeduel.matchmaking.rating-window-step-10s:100}")
    private int step10sWindow;

    @Value("${codeduel.matchmaking.rating-window-step-20s:200}")
    private int step20sWindow;

    @Value("${codeduel.matchmaking.rating-window-step-30s:500}")
    private int step30sWindow;

    @Value("${codeduel.matchmaking.queue-timeout-seconds:120}")
    ...
    @Scheduled(fixedDelayString = "${codeduel.matchmaking.poll-interval-ms:1000}")
